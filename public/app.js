(function(){
  ...
  $('#change-map-style-button-up').on('click', function() {
    googleMapHelper.changeMapStyle(1);
  });
  $('#change-map-style-button-down').on('click', function() {
    googleMapHelper.changeMapStyle(-1);
  });
  ...
  googleMapHelper = {
    ...
    changeMapStyle(change) {
      let index = (styleIndex += change) % (this.optionsArrays.length);
      console.log(index);
      console.log('-------------------------------------------------');
      console.log('THEME CHANGED TO: ' + this.namesArray[index]);
      console.log('-------------------------------------------------');
      newStyle = this.optionsArrays[index];
